...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        integer to appropriate variable and keeps the enter key(\n) unread in the keyboard buffer. So when it's time to supply
        String, the nextLine() will read the enter key from the user thinking that the user has entered the enter key.
        ...
        next(): read the input only till the space. It can't read two words separated by space. Also, next() places
        the cursor in the same line after reading the input.
